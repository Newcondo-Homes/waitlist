...
import { Shield, Users, Brain, TabletSmartphone  } from 'lucide-react'
            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative bg-[#131313] col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Verified Rentals, No Extra Fees</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden bg-[#131313] sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white"> Automatic Double-Booking Prevention</h2>
                                    <p className="text-foreground">Rented properties auto-disable links to prevent overbooking.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden bg-[#131313] sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Smart Property & Lease Management</h2>
                                    <p className="text-foreground">Easily organize listings, lease terms, and tenant records — all in one place.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="card variant-outlined relative bg-[#131313] col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Real-Time Agent Monitoring</h2>
                                        <p className="text-foreground">Track agent activity to boost transparency and reduce miscommunication.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="card variant-outlined relative bg-[#131313] col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Multi-Agent & Team Coordination</h2>
                                        <p className="text-foreground">Coordinate teams with shared dashboards and action history.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Tolu</span>
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">M. Emeka</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">B. Zain</span>
                                            <div className="ring-background size-7 ring-4">
                                                <img
                                                    className="size-full rounded-full"
